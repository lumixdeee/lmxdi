...
The `storyforge101` guide says that stories become containers filled with ordered pieces of information and that computers see labelled arrangements. This matters because prompts, RPG mechanics, story systems, and repository maps can all be treated as rule-bound imagination engines. Their function depends on labels, sequence, status, and permitted moves.
...
The same method works for story and tabletop material because stories also need route, role, status, and permitted moves. A deity list, prompt block, conlang particle set, civic bug report, and RPG mechanic can all be mapped as rule-bound units.

The repository mix supports this view. `storyforge101/Guides/How-Computers-Run-Stories.txt` states that computers see labelled arrangements, labels, statements, and ordered change. That is also how a prompt acts on a model.
...
[R1] https://github.com/lumixdeee/dragi/blob/main/README.md. Supplies the beast questions: what it eats, where it lives, what it is called, and what eats it.

[R2] https://github.com/lumixdeee/mogri/blob/main/README.md. Defines Mogri as a holding primitive, not an entity or mechanism.

[R3] https://github.com/lumixdeee/CSP-106/blob/main/Newsletter/mogri-brief-2026-02.md. States that Mogri separates modeling from claiming and should fail visibly if it fails.

[R4] https://github.com/lumixdeee/amphi/blob/main/paper/software_testing_as_civic_method_v0_001.md. Provides the civic testing bridge and defect-record method.

[R5] https://github.com/lumixdeee/storyforge101/blob/main/Guides/How-Computers-Run-Stories.txt. Describes stories as an ordered, labelled arrangement.

[R6] https://github.com/lumixdeee/lexii/blob/main/README.md. Frames small language repairs as a friction-reduction tool for long-running teams.

[R7] https://github.com/lumixdeee/lmxdi/blob/main/overhead-chakras. Example of symbolic map material that requires real-world authority limits.

[R8] https://github.com/lumixdeee/CSP-106/blob/main/MAP-%3ECSP-106%2CMogri-%26-More.txt. Repo-to-repo routing note for CSP-106, Mogri, Dragi, and related work.
